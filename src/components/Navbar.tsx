    ...
    <>
      <header
        ...
        className={`fixed top-0 left-0 w-full z-40 transition-all duration-500 ${
          isScrolled
            ? "bg-[#0B0B0B]/85 border-b border-white/5 backdrop-blur-xl py-4"
            : "bg-transparent py-6"
        }`}
      >
        <div className="max-w-7xl mx-auto px-6 md:px-12 flex items-center justify-between">
          ...
          >
            <div className="w-10 h-10 border border-luxury-gold flex items-center justify-center transition-all duration-300 group-hover:bg-luxury-gold/15 shrink-0">
              <span className="text-luxury-gold font-bold text-xl tracking-tighter font-display">RF</span>
            </div>
            <div className="text-left leading-none pl-1">
              <span className="text-xs tracking-[0.35em] uppercase font-light text-white block">
                RF MEDIA
              </span>
              <span className="font-serif italic text-[10px] tracking-[0.25em] text-luxury-gold block mt-0.5 uppercase">
                PRODUCTIONS
              </span>
            </div>
          </button>
      ...
      <AnimatePresence>
        {isMobileMenuOpen && (
          <motion.div
            ...
            className="fixed inset-0 z-30 bg-[#0B0B0B] pt-24 px-8 pb-10 flex flex-col justify-between"
          >
